...
export const SelectCountry = (navigation, callback, multi_select = false, selected_items = []) => {
	navigation.navigate('EntitySelector', {
		...
		selected_items_ids: selected_items,
		callback,
	})
}


export const SelectCity = (navigation, callback, parent_id, search = false) => {
...
export const SelectArea = (navigation, callback, parent_id, search = false) => {
	// Note: parent_id can be an integer or an array of integers
